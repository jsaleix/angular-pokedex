export const MockPokemonSpecies = {
  ...
  flavor_text_entries: [
    ...
    {
      flavor_text:
        'Il vit dans le Monde Distorsion, un monde à l’opposé\ndu nôtre qui échappe au sens commun.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Vive en el Mundo Distorsión, un mundo opuesto al\nnuestro y cuyas leyes desafían el sentido común.',
      language: {
        name: 'es',
    ...
    {
      flavor_text:
        'Vive nel Mondo Distorto che, sfidando l’ordine\ncosmico, si trova sul lato opposto al nostro.',
      language: {
        name: 'it',
    ...
    {
      flavor_text:
        'Es wurde aufgrund seines Verhaltens verbannt.\nAus der Zerrwelt schaut es auf die alte Welt.',
      language: {
        name: 'de',
        url: 'https://pokeapi.co/api/v2/language/6/',
      },
    ...
    {
      flavor_text:
        'Fue desterrado por su violencia. Observa el mundo\nen silencio desde el Mundo Distorsión.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text:
        'È stato bandito per la sua violenza. Osserva il\nvecchio mondo in silenzio dal Mondo Distorto.',
      language: {
        name: 'it',
        url: 'https://pokeapi.co/api/v2/language/8/',
      },
    ...
    {
      flavor_text:
        'Il vit dans le Monde Distorsion, un monde à l’opposé du nôtre\nqui échappe au sens commun.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Es lebt in einer Zerrwelt, die auf der Kehrseite der unseren\nliegt und die sich aller Logik entzieht.',
      language: {
        name: 'de',
        url: 'https://pokeapi.co/api/v2/language/6/',
      },
    ...
    {
      flavor_text:
        'Vive en el Mundo Distorsión, un mundo opuesto al nuestro y\ncuyas leyes desafían el sentido común.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text:
        'Vive nel Mondo Distorto che, sfidando l’ordine cosmico,\nsi trova sul lato opposto al nostro.',
      language: {
        name: 'it',
        url: 'https://pokeapi.co/api/v2/language/8/',
      },
    ...
    {
      flavor_text:
        'Sa grande violence lui a valu d’être banni. Il observe\nles hommes en silence depuis le Monde Distorsion.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Fue desterrado por su violencia. Observa el mundo en silencio\ndesde el Mundo Distorsión.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text:
        'È stato bandito per la sua violenza. Osserva il vecchio mondo\nin silenzio dal Mondo Distorto.',
      language: {
        name: 'it',
        url: 'https://pokeapi.co/api/v2/language/8/',
      },
    ...
    {
      flavor_text:
        'There is one Hisuian verse that tells of a powerful light creating\na deep shadow. I imagine that this deep shadow is Giratina.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
  ...
  form_descriptions: [
    {
      description:
        'Forms have different stats and can learn different moves from tutors.  Moves are retained through form changes.  Giratina transforms into Origin Forme in the distortion world or while holding a griseous orb.  Otherwise, it assumes its Altered Forme.\n\nIn Generation IV, the Griseous Orb returns to the bag upon entering the Wi-Fi Club or the Union Room.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
